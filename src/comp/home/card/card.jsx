...
const Cardsss = () => {
  ...
  <CardContent>
                    <h1 style={{textAlign:'center',color:'white'}}> Cryptocurrency market statistics</h1>
                    ...
                    <CardContent>
                        <Stack direction={'row'} pt={3} pb={3} justifyContent={'space-between'} alignItems={'center'}>
                            ...
                            <h2 style={{color:'white'}}>$ {millify(states.totalMarketCap)}</h2>
                        </Stack>
                        <hr />
                        <Stack direction={'row'} pt={3} pb={3}  justifyContent={'space-between'} alignItems={'center'}>
                        ...
                        <Stack direction={'row'} pt={3} pb={3} justifyContent={'space-between'} alignItems={'center'}>
                            ...
                            <h2 style={{color:'white'}} >{millify(states.total)}</h2>
                        </Stack>
                        <hr />
